...
read_verilog ./data/Netlist/EXACT_without_clock_mask.v
current_design Main
link

read_saif  ./data/SAIF/EXACT_without_clock_mask.from_dc.saif  -strip_path  Main


report_power  > ./data/log/report_power_primetime_exact_without_clock_mask.log
