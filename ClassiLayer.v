...
module ClassiLayer 
   (input reset,
    ...
    input clock,
    input data_valid,
    input wire [`PORT_2D(441, 10, 12)] Weight,
    input wire [`PORT_1D(10, 12)] Bias,
    input wire [`PORT_1D(10, 1)] Switch,
    input wire [`PORT_1D(441, 1)] InputData,
    output reg [`PORT_1D(10, 1)] OutputData,
    output reg finish
    );
   ...
   RandomGenerator  rnd(rand_reset, clock, 8'b00111111, RandomData);
   ...
   assign current_weight = `GET_2D(Weight, 10, 12, adding_cursor, cursor);
